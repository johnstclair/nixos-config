...
# this is a slightly modified version of the sway-launcher-desktop app
# https://github.com/Biont/sway-launcher-desktop
# i ran into issues after an update so im using this script untill the normal install works again
...
echo "Starting launcher instance with the following providers:" "${!PROVIDERS[@]}"
